...
import OsobaForm, { EditForm, EMPTY_FORM } from '@/components/OsobaForm'
...
export default function OsobyClient({ osoby: initial, openId }: { osoby: Osoba[]; openId?: string }) {
  ...
  const formProps = { editForm, setEditForm, ukladani, chyba }
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
              ...
              {view === 'detail' && vybrana && (
                <div className="flex flex-1 overflow-hidden">
                  ...
                  {/* Jednotky */}
                  <div className="w-72 flex-shrink-0 overflow-y-auto p-5 border-r border-zinc-100">
